...
Accepts: names (the accumulator dict, mutated in place), sa (any resolver result
from _serviceaccount-helpers.tpl: .create + .name; only a created, named SA is
registered, so callers pass the result whatever its create), owner (human-readable source, used in the message).
*/}}
