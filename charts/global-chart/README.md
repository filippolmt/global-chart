...
| rbacs.roles | string | `nil` | List of RBAC role definitions. When a serviceAccount is defined, a RoleBinding targeting that ServiceAccount is generated automatically. |
