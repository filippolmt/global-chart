...
- **A hook can run as an `rbacs.roles` ServiceAccount in a `pre-*` or
  `post-delete` phase** (ADR 0010). Helm applies the SA, Role and RoleBinding of
  ...
  Role and RoleBinding are copied. No values change.
