...
description: Use when modifying global-chart Helm templates, adding features, fixing bugs, or updating values. Covers hasKey vs truthiness pitfalls, global fallback chains, inheritance logic, validation with fail, deterministic rendering, and the required lint-test-generate workflow.
---
